...
const Home: React.FC = () => {
  ...
  const carouselSlides: CarouselSlide[] = [
    ...
    {
      src: "/photo-1491677533189-49af044391ed.avif",
      alt: "Banner Image 2",
    ...
    {
      src: "/photo-1692607038273-8f45f4b0b1c7.avif",
      alt: "Banner Image 3",
      title: "Por um meio ambiente mais limpo",
      description: "Desenvolvimento sustentável é o futuro!",
      buttonText: "SAIBA MAIS",
      buttonLink: "/store",
      buttonVariant: "dark" as const, 
    },
    {
      src: "/photo-1474631245212-32dc3c8310c6.avif",
      alt: "Banner Image 4",
      title: "Seja a mudança que você quer no mundo",
      description: "Desenvolvimento sustentável é o futuro!",
      buttonText: "SAIBA MAIS",
      buttonLink: "/store",
      buttonVariant: "dark" as const, 
